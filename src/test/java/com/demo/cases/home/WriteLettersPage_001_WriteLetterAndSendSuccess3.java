...
public class WriteLettersPage_001_WriteLetterAndSendSuccess3 extends LoginBase {
	...
	public void writeLetterAndSendSuccess3(String addressee, String theme,String exeName,String WritingContent) {
		// 打开已登录页面
