...
public class WriteLettersPage_001_WriteLetterAndSendSuccess4 extends LoginBase {
	...
	public void writeLetterAndSendSuccess4(String addressee, String theme,String exeName,String WritingContent) {
		// 打开已登录页面
