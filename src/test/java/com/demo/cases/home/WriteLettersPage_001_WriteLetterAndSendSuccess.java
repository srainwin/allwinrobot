...
public class WriteLettersPage_001_WriteLetterAndSendSuccess extends LoginBase {

	@Story("首页Tab") // allure用例组织，三级模块
	@Test(dataProvider = "testdata", description = "写信发送") // allure用例名是description
	@Description("登录邮箱后，在首页Tab下方点击写信，填写相关内容后发送邮件") // allure用例描述
	@Severity(SeverityLevel.NORMAL) // allure用例重要等级
	public void writeLetterAndSendSuccess(String addressee, String theme,String exeName,String WritingContent) {
		// 打开已登录页面
