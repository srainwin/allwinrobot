...
public class WriteLettersPage_001_WriteLetterAndSendSuccess5 extends LoginBase {
	...
	public void writeLetterAndSendSuccess5(String addressee, String theme,String exeName,String WritingContent) {
		// 打开已登录页面
